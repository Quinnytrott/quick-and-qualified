...
export function HomeownerInspectionForm() {
  ...
  return (
    <form
      ...
      onSubmit={(event) => submitLeadForm(event, setSubmitStatus, setIsSubmitting)}
    >
...
export function ContractorApplicationForm() {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-2xl font-semibold tracking-tight text-zinc-900">{CONTRACTOR_FORM_COPY.heading}</h2>
      ...
      <button
        ...
        type="submit"
      >
        {isSubmitting ? "Submitting..." : CONTRACTOR_FORM_COPY.submitLabel}
      </button>
